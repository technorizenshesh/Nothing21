...
public class AdapterFilterSize extends RecyclerView.Adapter<AdapterFilterSize.MyViewHolder> {
    Context context;
    ArrayList<SizeListModel.Result> arrayList;
    onPositionClickListener listener;

    public AdapterFilterSize(Context context, ArrayList<SizeListModel.Result> arrayList,onPositionClickListener listener) {
