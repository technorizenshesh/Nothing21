...
public class ColorSizeAdapter1 extends RecyclerView.Adapter<ColorSizeAdapter1.MyViewHolder> {
    Context context;
    ArrayList<ProductModelCopy.Result.ColorDetail> arrayList;
    onItemClickListener listener;

    public ColorSizeAdapter1(Context context,ArrayList<ProductModelCopy.Result.ColorDetail>arrayList,onItemClickListener listener) {
