...
public class EditSizeAdapter extends RecyclerView.Adapter<EditSizeAdapter.MyViewHolder> {
    Context context;
    ArrayList<ProductModelCopy.Result.ColorDetail> arrayList;
    onItemClickListener listener;

    public EditSizeAdapter(Context context, ArrayList<ProductModelCopy.Result.ColorDetail>arrayList, onItemClickListener listener) {
