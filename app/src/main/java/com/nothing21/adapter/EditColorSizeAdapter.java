...
public class EditColorSizeAdapter extends RecyclerView.Adapter<EditColorSizeAdapter.MyViewHolder> {
    Context context;
    ArrayList<ProductModelCopy.Result.ColorDetail> arrayList;
    onItemClickListener listener;

    public EditColorSizeAdapter(Context context, ArrayList<ProductModelCopy.Result.ColorDetail>arrayList, onItemClickListener listener) {
