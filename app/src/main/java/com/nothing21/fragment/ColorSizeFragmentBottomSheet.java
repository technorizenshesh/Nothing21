...
public class ColorSizeFragmentBottomSheet extends BottomSheetDialogFragment implements onItemClickListener {
    ...
    public ColorSizeFragmentBottomSheet(ProductModel.Result productData,String size) {
    ...
    public ColorSizeFragmentBottomSheet callBack(InfoListener listener) {
    ...
    private void initViews() {
        ...
        binding.rvColorSize.setAdapter(new ColorSizeAdapter(getActivity(), arrayList,ColorSizeFragmentBottomSheet.this));
