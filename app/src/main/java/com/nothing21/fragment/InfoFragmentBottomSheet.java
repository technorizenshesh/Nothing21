...
public class InfoFragmentBottomSheet extends BottomSheetDialogFragment {
    ...
    public InfoFragmentBottomSheet(ProductModel.Result productData) {
        this.productData = productData;
    }


    public InfoFragmentBottomSheet callBack(InfoListener listener) {
