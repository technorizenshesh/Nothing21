...
import com.nothing21.SplashAct;
...
public class SessionManager {
    ...
    public static final String PREF_NAME = "Nothing21";
    ...
    public static void Logout(String id, Context context) {
        Nothing21Interface apiInterface = ApiClient.getClient().create(Nothing21Interface.class);
